...
namespace SC_701_ProyectoG4_Horarios.Controllers
{
    public class ReservacionesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProfesorId"] = new SelectList(_context.Profesores
                        .Include(p => p.Usuario)
                        .Select(p => new
                        {
                            Id = p.Id,
                            NombreCompleto = p.Usuario.Nombre + " " + p.Usuario.PrimerApellido + " " + p.Usuario.SegundoApellido
                        })
                        .ToList(),
                        "Id",
                        "NombreCompleto");
