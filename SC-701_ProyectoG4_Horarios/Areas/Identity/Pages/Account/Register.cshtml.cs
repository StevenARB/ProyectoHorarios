...
namespace SC_701_ProyectoG4_Horarios.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Se agrega el rol por defecto Profesor
                    var resultRole = await _userManager.AddToRoleAsync(user, "Profesor");
